...
import vitePluginTdoc from '../dist/vite-plugin-ddoc.esm.js';
  ...
  plugins: [
    ...
    vitePluginTdoc({
      markdown: {
        ...
        toc: {
          containerClass: `d-toc_container`,
          listClass: `d-toc_list`,
          itemClass: `d-toc_list_item`,
          linkClass: `d-toc_list_item_a`,
        },
